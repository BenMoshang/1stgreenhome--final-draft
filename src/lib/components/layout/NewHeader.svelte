...
>
  <a class="header__logo" href="/" aria-label="Homepage">
    ...
    >
      <path fill="currentColor" opacity="1.000000" stroke="none" d={logoPathMain} />
      <path fill="currentColor" opacity="1.000000" stroke="none" d={logoPathSecondary} />
    </svg>
  </a>
  ...
  <!-- desktop navigation -->
  <nav class="header__nav header__nav--desktop" aria-label="Primary desktop navigation">
...
<style lang="scss">
  ...
  .header__nav-link {
    font-weight: 500;
    color: var(--on-surface-container); /* Using typography color levels */
  }

  .header__nav-item--desktop:last-child .header__nav-link {
    color: var(--brute-primary);
    font-weight: 700;
  ...
  .header__nav-list--mobile {
    ...
    justify-content:center;
    align-items: center;
    gap: size('md'); /* Using spacing system variable */
    opacity: 1;
  ...
  .header__nav-list--mobile li:last-child {
    font-weight: 700;
  }
  ...
  .header__nav-footer-content-container {
    ...
    flex-direction: column;
    justify-content: center;
    gap: size('sm'); /* Using spacing system variable */
  }
  ...
  .header__nav-footer--mobile {
    ...
    justify-content:center;
    align-items:center;
    gap: var(--spacing-xs); /* Using spacing system variable */
  ...
  :is(
  .header__nav-footer-email,
  .header__nav-footer-phone) {
    @extend %u_callout;
    @extend %a-link;
  }
...
block-size:100%;
  ...
  .header__nav-footer-address {
    @extend %u_callout;
    @extend %typography--tertiary; /* Using typography color levels */
    line-height:1.5;
  }
  ...
  .blur-fade-in {
    ...
    animation: blur-fade-in var(--transition-fade-in, 0.5s) var(--easing-smooth) forwards;
  }

  .blur-fade-out {
    --easing-smooth: cubic-bezier(0.32, 0.72, 0, 1);
    animation: blur-fade-out var(--transition-standard, 0.3s) var(--easing-smooth) forwards;
    pointer-events: none;
  }
