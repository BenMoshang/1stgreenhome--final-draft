...
<style>
  * {
  ...
  hr {
    border: none;
    border-radius: 100%;
    background-color: var(--color-secondary); /* Dark green color */
    block-size: 0.1875rem; /* Thickness */
    inline-size: 100%;
    opacity: 0.55;
  }
  ...
  .footer__circle {
    ...
    block-size: var(--stepper-circle-size);
    box-shadow: var(--shadow-medium--secondary);
    inline-size: var(--stepper-circle-size);
    justify-self: center;
  }
