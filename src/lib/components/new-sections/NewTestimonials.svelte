<script lang="ts">
  ...
  const testimonials = $state([
    {
      pfp: base + `/assets/landing-page/testimonial/headshot1.jpg`,
      name: `Jack Amoruso`,
    ...
    {
      pfp: base + `/assets/landing-page/testimonial/headshot5.jpg`,
      name: `Rick Schmidt`,
      company: `84 Lumber`,
    ...
    },
    {
      ...
      pfp: base + `/assets/landing-page/testimonial/headshot3.jpg`,
    },
    {
      pfp: base + `/assets/landing-page/testimonial/headshot4.jpg`,
      name: `David Shin`,
    ...
    {
      pfp: base + `/assets/landing-page/testimonial/headshot2.jpg`,
      name: `Oddy Okojie`,
      company: `M&amp;M Bedding`,
